...
<div {{ $attributes }} data-obsidian-ui-code>
    ...
    <div x-data="obsidianui_code" class="relative">
        ...
        <div class="absolute top-0 right-0 cursor-pointer opacity-80" x-show="!copied" @click="copy" x-transition.opacity>
        ...
        <div class="absolute top-0 right-0 cursor-pointer opacity-80" x-cloak x-show="copied" x-transition.opacity>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
